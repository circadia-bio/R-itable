...
**R-itable** ([`library(itable)`](https://r-itable.circadia-lab.uk))
...
[`vignette("getting-started", package = "itable")`](https://r-itable.circadia-lab.uk/articles/getting-started.md).
